...
class Query(BaseModel):
    ...
    from_currency: str = Field("EUR", description="Currency to convert from (default: EUR)")
    to_currency: Optional[str] = Field(None, description="Currency to convert to")
    misc: Optional[str] = Field(None, description="Additional notes or requirements")
    desc: Optional[str] = Field(None, description="Description of the query")
